...
const ANTIGRAVITY_ENDPOINT_PROD =
  process.env.ANTIGRAVITY_ENDPOINT_PROD ||
...
export const DEFAULT_PROJECT_ID =
  process.env.DEFAULT_PROJECT_ID || "rising-fact-p41fc";

export const TOKEN_REFRESH_INTERVAL_MS =
  parseInt(process.env.TOKEN_REFRESH_INTERVAL_MS) || 5 * 60 * 1000; // 5 minutes
export const REQUEST_BODY_LIMIT = process.env.REQUEST_BODY_LIMIT || "50mb";
export const ANTIGRAVITY_AUTH_PORT =
  parseInt(process.env.ANTIGRAVITY_AUTH_PORT) || 9092;
export const DEFAULT_PORT = parseInt(process.env.PORT) || 8080;
...
export const DEFAULT_COOLDOWN_MS =
  parseInt(process.env.DEFAULT_COOLDOWN_MS) || 10 * 1000; // 10 second default cooldown
export const MAX_RETRIES = parseInt(process.env.MAX_RETRIES) || 5; // Max retry attempts across accounts
export const MAX_EMPTY_RESPONSE_RETRIES =
  parseInt(process.env.MAX_EMPTY_RESPONSE_RETRIES) || 2; // Max retries for empty API responses
export const MAX_ACCOUNTS = parseInt(process.env.MAX_ACCOUNTS) || 10; // Maximum number of accounts allowed

// Rate limit wait thresholds
export const MAX_WAIT_BEFORE_ERROR_MS =
  parseInt(process.env.MAX_WAIT_BEFORE_ERROR_MS) || 120000; // 2 minutes - throw error if wait exceeds this
...
export const GEMINI_MAX_OUTPUT_TOKENS =
  parseInt(process.env.GEMINI_MAX_OUTPUT_TOKENS) || 16384;
...
export const GEMINI_SIGNATURE_CACHE_TTL_MS =
  parseInt(process.env.GEMINI_SIGNATURE_CACHE_TTL_MS) || 2 * 60 * 60 * 1000;
